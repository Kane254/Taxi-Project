...
from .views import BookingCreateView, RiderBookingListView, DriverBookingListView, tsavo_details_view, shimba_details_view, diani_retreat_view, shimoni_caves_view, kinondo_sacred_forest_view, wasini_dolphin_view, contact_view, contact_submit, ReviewCreateView, about_view
